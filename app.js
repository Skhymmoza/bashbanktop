            ...
            const response = await fetch(API_URL, {
                ...
                body: JSON.stringify({
                    ...
                    messages: [
                        {
                            role: "system", 
                            content: "Ты — вежливый оператор поддержки магазина игровой валюты 'BR SHOP'. Ты помогаешь пользователям с покупкой виртов в игре Black Russia. Отвечай кратко, по делу и на русском языке. Не говори, что ты ИИ. Если спрашивают про оплату - говори, что оплата проходит через карту или СБП."
                        },
